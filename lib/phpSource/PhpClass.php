 ...
 */
class PhpClass extends \phpSource\PhpElement
{
  /**
   *
   ...
   * @param bool $final
   */
  public function __construct($identifier, $classExists = false, $extends = '', \phpSource\PhpDocComment $comment = null, $final = false)
  {
   ...
   *
   * @param \phpSource\PhpVariable $variable The variable object to add
   * @access public
   * @throws \Exception If the variable name already exists
   */
  public function addVariable(\phpSource\PhpVariable $variable)
  {
   ...
   * Overwrites
   *
   * @param \phpSource\PhpFunction $function The function object to add
   * @access public
   * @throws \Exception If the function name already exists
   */
  public function addFunction(\phpSource\PhpFunction $function)
  {
