 ...
 */
class PhpFunction extends \phpSource\PhpElement
{
  /**
   *
  ...
  /**
   *
   * @var \phpSource\PhpDocComment A comment in phpdoc format that describes the function
   * @access private
   */
  private $comment;
   ...
   */
  function __construct($access, $identifier, $params, $source, \phpSource\PhpDocComment $comment = null)
  {
    $this->access = $access;
