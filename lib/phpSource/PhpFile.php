...
class PhpFile
{
  ...
  /**
   *
   * @var array Array of \phpSource\PhpFunction objects
   * @access private
   */
  private $functions;
   ...
   *
   * @param \phpSource\PhpClass $class The class to add
   * @throws \Exception If the class already exists
   */
  public function addClass(\phpSource\PhpClass $class)
  {
   ...
   *
   * @param \phpSource\PhpFunction $function The function to add
