 ...
 */
class Cli extends \cli\CliParser
{
  /**
   *
  ...
  public function addFlag($flag, $description, $isBool = false, $required = false)
  {
    ...
    // Not busy, add it
    $this->acceptedFlags[$flag] = new \cli\Flag($flag, $description, $isBool);
  ...
  public function validate(array $argv)
  {
    ...
    {
      $this->acceptedFlags['-h'] = new \cli\Flag('-h', _('Help'), true);
    }
   ...
   *
   * @param string $flag
   * @return \cli\Flag|null Returns the flag either by name or alias
   */
