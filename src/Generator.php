...
class Generator
{
  ...
  /**
   *
   * @var \wsdl2php\DocumentationManager A manager for the documentation
   */
  ...
  public function __construct()
  {
    ...
    $this->enums = array();
    $this->simple = array();
    $this->documentation = new \wsdl2php\DocumentationManager();

    if (self::$instance != null)
    {
      throw new \wsdl2php\Exception('\wsdl2php\Generator is only supposed to be constructed once. Check your code!');
    }
   ...
   *
   * @see \wsdl2php\Config
   * @param \wsdl2php\Config $config The config to use for generation
   * @access public
   */
  public function generate(\wsdl2php\Config $config)
  {
    $this->config = $config;
  ...
  private function loadService()
  {
    ...
    $this->service = new \wsdl2php\Service($name, $this->types, $this->documentation->getServiceDescription());
    ...
    foreach($functions as $function)
    {
      ...
      else
      {
        ...
        throw new \wsdl2php\Exception('Invalid function call: '.$function);
      }
  ...
  private function loadTypes()
  {
    ...
    foreach($types as $typeStr)
    {
      ...
      if ($numParts > 1)
      {
        $type = new \wsdl2php\ComplexType($className);
  ...
  // TODO: TEST TEST TEST. More tests needs to be written
   ...
   *
   * @return \wsdl2php\Generator The dreaded singleton instance
   */
   ...
   *
   * @return \wsdl2php\Config The loaded config
   */
