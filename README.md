...
[@dypa](https://github.com/dypa/), [@Lafriks](https://github.com/Lafriks/), [@SamMousa](https://github.com/SamMousa/), [@garex](https://github.com/garex/), [@honzap](https://github.com/honzap/), [@jk](https://github.com/jk/) and [@kasperg](https://github.com/kasperg/).
...
1. Download [wsdl2phpgenerator-2.5.5.phar](https://github.com/wsdl2phpgenerator/wsdl2phpgenerator/releases/download/2.5.5/wsdl2phpgenerator-2.5.5.phar) from [the latest release](https://github.com/wsdl2phpgenerator/wsdl2phpgenerator/releases/latest)
...
1. Add `"wsdl2phpgenerator/wsdl2phpgenerator": "2.5.5"`  to the `require` or `require-dev` section of your `composer.json` file
