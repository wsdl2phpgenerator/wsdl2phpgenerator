...
class Wsdl2PhpConfigTest extends PHPUnit_Framework_TestCase
{
  ...
  {
    $this->object = new Config('inputFile.xml', '/tmp/output', true, true, true, 'myNamespace', array('SOAP_SINGLE_ELEMENT_ARRAYS'), 'WSDL_CACHE_BOTH', 'SOAP_COMPRESSION_ACCEPT | SOAP_COMPRESSION_GZIP', 'test,test2, test3');
  }
